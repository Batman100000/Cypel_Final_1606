      ...
      <nav className="container mx-auto px-4 h-16 flex items-center justify-between">
        <a href="#" className="flex items-center gap-2 group">
          <img
            ...
            width={56}
            height={56}
            className="w-14 h-14 object-cover rounded-full ring-1 ring-primary/40 drop-shadow-[0_0_12px_hsl(var(--primary)/0.5)] group-hover:scale-110 transition-transform"
          />
